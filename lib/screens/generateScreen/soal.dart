...
import '../../widgets/generatePage/form_soal.dart';

class GenerateSoal extends StatefulWidget {
  @override
  _GenerateSoalState createState() => _GenerateSoalState();
}

class _GenerateSoalState extends State<GenerateSoal> {
  @override
  void initState() {
    super.initState();
