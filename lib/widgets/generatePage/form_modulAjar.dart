...
class _FormSectionState extends State<FormSection> {
    ...
    return Column(
      children: [
        ...
        const Align(
          alignment: Alignment.centerLeft,
          child: Text(
            'Gunakan Template Modul Ajar Kurikulum Merdeka',
            style: TextStyle(
              fontFamily: 'poppins',
              fontSize: 14,
              color: Colors.grey,
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            labelText: 'Masukan Nama Modul Ajar',
            filled: true,
            fillColor: const Color(0xFFF6F7FA),
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(10),
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          maxLength: 250,
          maxLines: 3,
          decoration: _inputDecoration('Masukkan Deskripsi Modul Ajar'),
          onChanged: (value) {
  ...
  Widget buildActionButtons() {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton.icon(
            onPressed: _isLoading ? null : generateModulAjar,
            icon: _isLoading
                ? const SizedBox(
                    height: 20,
                    width: 20,
  ...
  void generateModulAjar() async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        final response = await AuthService().generateModulAjar(
        ...
        if (response['status'] == true) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ResponsePage(responseData: response),
            ),
          );
        } else {
